        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full space-y-6">
                ...
                <p className="text-gray-600 mt-2">
                    Join our community and discover elegant fashion
                </p>
            </div>
            {/* Sign Up Card */}
            <Card className="bg-white border border-gray-200 shadow-lg rounded-xl overflow-hidden">
                    ...
                    <SignUp 
                        ...
                        appearance={{
                            elements: {
                                ...
                                formResendCodLink: "text-gray-900 hover:text-gray-700",
                ...
                <Card className="bg-white border border-gray-200 rounded-xl">
                    <CardContent className="p-6">
                        <h3 className="font-semibold text-gray-900 mb-4 font-sans">Why join us?</h3>
