...
export const CategoryCard = ({ name, slug }: CategoryCardProps) => {
  return (
    ...
    >
      <div className="relative rounded-xl overflow-hidden transform transition-all duration-300 group-hover:-translate-y-1 group-hover:scale-105 shadow-md hover:shadow-lg border border-gray-200/50 bg-white/80 backdrop-blur-sm min-h-[140px] flex items-center justify-center p-4">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-10 group-hover:opacity-15 transition-opacity duration-300">
          <Plus className="w-16 h-16 text-gray-500" />
        </div>
